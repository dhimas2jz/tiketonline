	...
	<div class="box">
		...
		<h4>
			...
			<div class="pull-right">
				...
				<a href="add.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah Penumpang </a>
			</div>
			...
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th><center>Nama Penumpang</center></th>
						<th><center>Alamat Penumpang</center></th>
					...
					while($data = mysqli_fetch_array($sql_penumpang)) { ?>
						<tr>
							...
							<td class="text-center">
								<a href="edit.php?id=<?=$data['id_penumpang']?>" class="btn btn-warning"><i class="	glyphicon glyphicon-edit"></i></a>
							<td class="text-center">
								<a href="delete.php?id=<?=$data['id_penumpang']?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
