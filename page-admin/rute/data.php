	...
	<div class="box">
		...
		<h4>
			...
			<div class="pull-right">
				...
				<a href="add.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah Rute </a>
			</div>
					...
					while($data = mysqli_fetch_array($sql_rute)) { ?>
						<tr>
							...
							<td class="text-center">
								<a href="edit.php?id=<?=$data['id_rute']?>" class="btn btn-warning"><i class="	glyphicon glyphicon-edit"></i></a>
							<td class="text-center">
								<a href="delete.php?id=<?=$data['id_rute']?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
