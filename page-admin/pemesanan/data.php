	...
	<div class="box">
		...
		<h4>
			...
			<div class="pull-right">
				...
				<a href="add.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah pemesanan </a>
			</div>
				...
				if(mysqli_num_rows($sql_pemesanan) > 0) {
					while($data = mysqli_fetch_array($sql_pemesanan)) { ?>
						<tr>
							...
							<td class="text-center">
								<a href="edit.php?id=<?=$data['id_pemesanan']?>" class="btn btn-warning"><i class="	glyphicon glyphicon-edit"></i></a>
							<td class="text-center">
								<a href="delete.php?id=<?=$data['id_pemesanan']?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
