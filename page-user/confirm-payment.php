...
<center><h3 style="margin-bottom: 40px;">Konfirmasi Pembayaran</h3></center>
<center><img src="../_assets/img2/transfer-icon.png" style="width: 490px;"></center>
        <?php
        ...
        if(mysqli_num_rows($sql_penumpang) > 0) {
          while($data = mysqli_fetch_array($sql_penumpang)) { ?>
            <center><h5>Silahkan transfer ke nomer rekening yang tertera di atas, dan sertakan bukti pembayaran.</h5></center>
          ...
          while($data = mysqli_fetch_array($sql_pemesanan)) { ?>
            <form action="proses.php" method="post" enctype="multipart/form-data">
              <div class="col-sm-3">
                ...
                <div class="form-group">
                  <label>Bukti</label>
                  <input type="file" name="bukti" value="" class="form-control" >
                </div>
              </div>
              <div class="col-sm-4 col-sm-offset-5"">
                <div class="form-group">
                  <input type="submit" name="bukti_pembayaran" value="Proses Pembayaran" class="btn btn-success">
                </div>
              </div>
            </form>
        <?php
