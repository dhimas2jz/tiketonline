    ...
    <?php 
          ...
          <div class="form-group">
            <label>Rute :</label>
              <select name="id_rute" class="form-control">
                <?php
                $rute = mysqli_query($con, "SELECT * FROM tb_rute INNER JOIN tb_transportasi ON tb_transportasi.id_transportasi = tb_rute.id_transportasi INNER JOIN tb_type_transportasi ON tb_type_transportasi.id_type_transportasi = tb_transportasi.id_type_transportasi WHERE nama_type='Kereta Api'");
      ...
      <?php 
        ...
        if($num <> 0)
        {
          ...
          $bikin_kode = str_pad($kode, 3, "0", STR_PAD_LEFT);
          $tahun = date('Ym');
          $kode_jadi = "KRAKK{$tgl}{$bikin_kode}";
       ?>
        <div class="form-group">
...
<div id="labelabu">
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="col-sm-2">
          <input type="text" name="subsemail" class="form-control" placeholder="Masukan email Anda">
        </div>
        <div class="col-sm-2">
          <input type="submit" name="sendemail" value="Berlangganan" class="btn btn-danger">
        </div>
      </div>
    </div>
</div>
